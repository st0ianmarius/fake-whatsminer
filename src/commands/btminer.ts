  ...
  const devs = [
    {
      DEVS: minerStats.hashboards.map((hashboard) => ({
        ...
        'Chip Frequency': hashboard.chipFrequency,
        'Effective Chips': hashboard.meta.effectiveChips,
        'Hardware Errors': 0,
        'Last Valid Work': getUnixTime(new Date()),
        Accepted: hashboard.poolShares.accepted,
        Rejected: hashboard.poolShares.rejected,
      })),
    },
  ];
